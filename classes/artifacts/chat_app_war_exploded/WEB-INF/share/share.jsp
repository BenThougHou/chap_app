...
<script type="text/javascript">
	function is_weixin() {
		...
		if (ua.match(/MicroMessenger/i) == "micromessenger") {
			...
			$('.download-btn span').show();
		};
	}
	is_weixin();

	function on_click_collect_data() {
		$.ajax({
			type : 'POST',
	...
	/** 下载app**/
	function on_click_doload(obj) {
		
		var clipboard = new ClipboardJS("." + $(obj).attr("class") + "", {
			text : function() {
// 				alert("ok");
				return "chat:userId=" + $('#userId').val();
			}
		});
